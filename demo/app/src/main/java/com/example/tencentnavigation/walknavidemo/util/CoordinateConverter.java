 ...
 * 
 * see https://github.com/wandergis/coordtransform实现的Java版本
 * @author geosmart
 */
public class CoordinateConverter {
	...
	public static double[] gcj02towgs84_exact(double gcjLat, double gcjLng) {
		...
		for (int i = 0; i < 30; i++) {
			wgsLat = (mLat + pLat) / 2;
			wgsLng = (mLng + pLng) / 2;
			double[] result = wgs84togcj02(wgsLng, wgsLat);
			double tmpLat = result[1];
			double tmpLng = result[0];
			dLat = tmpLat - gcjLat;
			dLng = tmpLng - gcjLng;
